...
Route::post('/quiz/create', 'ExamController@storeResults')->middleware('auth');
...
Route::group(['middleware'=>'isAdmin'], function() {
    ...
    Route::get('/quiz/{id}/questions','QuizController@viewQuestions')->name('quiz.question');
    ...
    Route::get('exam/user','ExamController@userExam')->name('view.user');
